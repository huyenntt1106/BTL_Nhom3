    ...
    public partial class frmBaoCaoDoanhThu : Form
    {
        ...
        private void btnHienThi_Click(object sender, EventArgs e)
        {
            ...
            if (mskNgay.Text != "  /  /")
            {
                ...
                sql += " and a.NgayTra= N'" + Functions.ConvertDateTime(mskNgay.Text) + "'";
            ...
            if (mskTuNgay.Text != "  /  /" && mskDenNgay.Text != "  /  /")
            {
                ...
                sql += " and (a.NgayTra between '" + Functions.ConvertDateTime(mskTuNgay.Text) + "' and '" + Functions.ConvertDateTime(mskDenNgay.Text) + "')";
                sql1 += " and (a.NgayTra between '" + Functions.ConvertDateTime(mskTuNgay.Text) + "' and '" + Functions.ConvertDateTime(mskDenNgay.Text) + "')";
            }
            dt = Convert.ToDouble(Functions.GetFieldValues1("select sum(a.TongTien) " + sql1));
