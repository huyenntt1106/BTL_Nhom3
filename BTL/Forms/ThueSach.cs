...
namespace BTL.Forms
{
    public partial class frmThueSach : Form
    {
        ...
        private void frmThueSach_Load(object sender, EventArgs e)
        {
            ...
            // txtTongTien.Text = "";
            Class.Functions.FillCombo2("select MaKhach,TenKhach from tblKhachHang", cboMaKH, "MaKhach", "TenKhach");
            cboMaKH.SelectedIndex = -1;
            Class.Functions.FillCombo2("select MaNhanVien,TenNhanVien from tblNhanVien", cboMaNV, "MaNhanVien", "TenNhanVien");
            cboMaNV.SelectedIndex = -1;
            Class.Functions.FillCombo2("select MaSach,TenSach from tblSachTruyen", cboMaSach, "MaSach", "TenSach");
            cboMaSach.SelectedIndex = -1;
            Class.Functions.FillCombo2("select MaTinhTrang,TenTinhTrang from tblTinhTrang", cboMaTinhTrang, "MaTinhTrang", "TenTinhTrang");
            cboMaTinhTrang.SelectedIndex = -1;
            Class.Functions.FillCombo2("select MaThue from tblChiTietThueSach", cboMaThue, "MaThue", "MaThue");
...
MessageBoxButtons.OK, MessageBoxIcon.Warning);
        ...
        {
            Functions.FillCombo1("select MaThue from tblThueSach ", cboMaThue, "MaThue", "MaThue");
            cboMaThue.SelectedIndex = -1;
        }

        private void frmThueSach_FormClosing(object sender, FormClosingEventArgs e)
        {
            ResetValues();
        }
