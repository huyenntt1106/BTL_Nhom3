...
namespace BTL.Forms
{
    public partial class frmKhachHang : Form
    {
        ...
        {
            string sql = "";
           string connectionString = "Data Source=DESKTOP-0BKJQ7L\\MAY1;Initial Catalog=BaiTapLon;Integrated Security=True;Encrypt=False";
            ...
            else if (cboTimkiem.SelectedItem.ToString() == "Tên khách")
            {
                ...
                else
                {
                    ...
                    sql = "SELECT * FROM tblKhachHang WHERE TenKhach LIKE N'%" + txtTimkiem.Text + "%'";
                }
            }
            else
            {
