...
{
    public partial class BaoCaoThueSach : Form
    {
        public BaoCaoThueSach()
        {
            InitializeComponent();
        }

        private void BaoCaoThueSach_Load(object sender, EventArgs e)
        {
            ...
            Class.Functions.FillCombo("select MaTra from tblChiTietTraSach", cboMaTra, "MaTra", "MaTra");
            ...
            Class.Functions.FillCombo("select MaKhach, TenKhach from tblKhachHang", cboTenKhach, "MaKhach", "TenKhach");
            cboTenKhach.SelectedValue = -1;
            Class.Functions.FillCombo("select MaNhanVien, TenNhanVien from tblNhanVien", cboTenNhanVien, "MaNhanVien", "TenNhanVien");
        ...
        private void btnHienThi_Click(object sender, EventArgs e)
        {
            ...
            if (mskNgay.Text != "  /  /")
            {
                ...
                sql2 += "and a.NgayTra= N'" + Functions.ConvertDate(mskNgay.Text) + "'";
            ...
            if (mskTuNgay.Text != "  /  /" && mskDenNgay.Text != "  /  /")
            {
                ...
                sql2 += "and (a.NgayTra between '" + Functions.ConvertDate(mskTuNgay.Text) + "' and '" + Functions.ConvertDate(mskDenNgay.Text) + "')";
            }
            load_data1(sql1);
